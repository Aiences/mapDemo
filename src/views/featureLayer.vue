  ...
  methods: {
    ...
    getFeatureLayer(msg) {
      ...
      var renderer = {
        ...
        valueExpression:
          "$feature['" + $this.displayConfig.otherName + "'] * 1000",
      ...
      this.featureLayer = new this.gisConstructor.FeatureLayer({
        ...
        popupTemplate: {
          ...
          content: function (g) {
            ...
            div.innerHTML =
              g.graphic.attributes[$this.type] +
              "影响因素：" +
              round(g.graphic.attributes[$this.displayConfig.otherName]);

            query.where =
              $this.typeId2[$this.displayConfig.type] +
              "='" +
              g.graphic.attributes[$this.typeId1[$this.displayConfig.type]] +
              "'";
            ...
            queryTask.execute(query).then(function (results) {
              ...
              for (var i = 0; i < 10 && i < results.features.length; i++) {
                ...
                div.innerHTML +=
                  ...
                  item.CourtName +
                  ":" +
                  round(item[$this.displayConfig.name]);
              }
            });
