  ...
  <div id="queryMap">
    ...
    <div id="queryDiv" class="esri-widget">
      ...
      <br />
      <button class="esri-button" @click="clearGeometry()" type="button">
        清空
      </button>
    </div>
    ...
    <div id="resultDiv" class="esri-widget" v-show="resultBox">
      ...
      <div class="charts">
        <ul>
          <li v-for="(value, key) in resultObj" :key="value">
            {{ key }}:{{ value }}
          </li>
        </ul>
      </div>
...
export default {
  ...
  methods: {
    ...
    updateSceneLayer() {
      ...
      return this.sceneLayerView.queryObjectIds(query).then((res) => {
